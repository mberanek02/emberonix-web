...
export default function MemotiveTechPage() {
  return (
    <>
      <BackgroundParticles />
      <Navbar />
      <main className="relative z-10">
        <ProjectHero
          ...
          stats={[
            { label: 'Memory Categories', value: '6' },
            { label: 'Active Coach Tools', value: '15' },
            { label: 'Backend Tests', value: '895+' },
        ...
        <ProjectSection label="Shipped Features" title="What Was Built">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
            ...
            <div>
              ...
              <p className="font-sans text-body text-text-muted leading-relaxed">
                iMessage-style photo staging with multi-image support, per-item macro tracking, and meal deduplication. All integrated naturally into the chat flow.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-sans text-body text-text-muted leading-relaxed">
                Prompt caching delivers significant token savings. Smart routing between Claude Sonnet (complex reasoning) and Haiku (routine tasks) with real-time cost tracking and per-user budget controls.
              </p>
            </div>
          </div>
        </ProjectSection>
